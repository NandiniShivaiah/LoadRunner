# 1 "d:\\loadrunner script\\google_images_language\\\\combined_Google_Images_Language.c"
...
# 1 "d:\\loadrunner script\\google_images_language\\\\combined_Google_Images_Language.c" 2
...
# 2 "d:\\loadrunner script\\google_images_language\\\\combined_Google_Images_Language.c" 2
...
# 3 "d:\\loadrunner script\\google_images_language\\\\combined_Google_Images_Language.c" 2
...
# 4 "d:\\loadrunner script\\google_images_language\\\\combined_Google_Images_Language.c" 2
...
Action()
{
	...
	web_submit_form("appointment.php", 
		"Snapshot=t18.inf", 
		"ITEMDATA", 
		"Name=facility", "Value={name}", "ENDITEM", 
		"Name=hospital_readmission", "Value={Yes}", "ENDITEM", 
		"Name=programs", "Value={medi}", "ENDITEM", 
		"Name=visit_date", "Value={DT}", "ENDITEM", 
		"Name=comment", "Value={SN}" 
		"", "ENDITEM",
		"LAST");
...
# 5 "d:\\loadrunner script\\google_images_language\\\\combined_Google_Images_Language.c" 2
...
# 6 "d:\\loadrunner script\\google_images_language\\\\combined_Google_Images_Language.c" 2
