# 1 "d:\\loadrunner script\\supertails\\case study\\\\combined_Case Study.c"
...
# 1 "d:\\loadrunner script\\supertails\\case study\\\\combined_Case Study.c" 2
...
# 2 "d:\\loadrunner script\\supertails\\case study\\\\combined_Case Study.c" 2
...
# 3 "d:\\loadrunner script\\supertails\\case study\\\\combined_Case Study.c" 2
...
# 4 "d:\\loadrunner script\\supertails\\case study\\\\combined_Case Study.c" 2
...
Login()
{
	...
	web_submit_data("authenticate.php", 
		...
		"Mode=HTML", 
		"ITEMDATA", 
		"Name=username", "Value=JohnDoe", "ENDITEM", 
		"Name=password", "Value=ThisIsNotAPassword", "ENDITEM", 
		"LAST");

	return 0;
}
# 5 "d:\\loadrunner script\\supertails\\case study\\\\combined_Case Study.c" 2
...
# 6 "d:\\loadrunner script\\supertails\\case study\\\\combined_Case Study.c" 2
